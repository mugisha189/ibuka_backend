...
@ApiQuery({ name: 'search', type: 'string', required: false, description: 'Search across family names, provinces, districts, sectors, cells, and villages' })
@ApiQuery({ name: 'deceased_families', type: 'string', required: false, description: 'Filter by deceased families status' })
@ApiQuery({ name: 'survived_families', type: 'string', required: false, description: 'Filter by survived families status' })
@ApiQuery({ name: 'testimonial_families', type: 'string', required: false, description: 'Filter families with testimonials' })
@ApiQuery({ name: 'sector', type: 'string', required: false, description: 'Filter by current or survival sector' })
@ApiQuery({ name: 'survivors', type: 'number', required: false, description: 'Filter by number of survivors' })
@ApiQuery({ name: 'testimonials', type: 'number', required: false, description: 'Filter by number of testimonials' })
